...
rm -f   /bin/hopper.server
rm -f   /etc/systemd/system/shepherd-runner_helper.service

cp -arv ${PATCH_DIRECTORY}/home/pi/* /home/pi
cp -arv ${PATCH_DIRECTORY}/etc/systemd/system/* /etc/systemd/system
cp -arv ${PATCH_DIRECTORY}/usr/local/bin/* /usr/local/bin
